      ...
      >
        ...
        <IonTabButton key="wallet" tab="wallet" className={edit.tab} onClick={() => handleTabClick('/wallet')}>
          <div className="tab-wallet">
            ...
            <div style={{ fontWeight: activeTab === 'wallet' ? '700' : '', fontSize: '10px', color: "var(--ion-company-wood)" }}>Inbox</div>
          </div>
        </IonTabButton>
        ...
        <IonTabButton key="jobs" tab="jobs" className={edit.tab} onClick={() => handleTabClick('/jobs')}>
          <div className="tab-jobs">
            ...
            <div style={{ fontWeight: activeTab === 'jobs' ? '700' : '', fontSize: '10px', color: "var(--ion-company-wood)" }}>Notification</div>
          </div>
        </IonTabButton>

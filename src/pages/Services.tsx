...
const fetchCategories = async (): Promise<Category[]> => {
  const url = 'https://myendpoint.atwebpages.com/fetchCategory.php';
...
const Services: React.FC = () => {
  ...
  const handleCategoryClick = async (category: Category) => {
    ...
    try {
      const response = await fetch(`https://myendpoint.atwebpages.com/fetchSub.php?categoryId=${category.id}`);
      if (!response.ok) {
  ...
  const openChatWithSupervisor = async (
    ...
    try {
      const response = await fetch('https://myendpoint.atwebpages.com/saveChat.php', {
        method: 'POST',
